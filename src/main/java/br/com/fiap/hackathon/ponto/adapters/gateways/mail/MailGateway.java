package br.com.fiap.hackathon.ponto.adapters.gateways.mail;

import br.com.fiap.hackathon.ponto.adapters.gateways.mail.mappers.MailMapper;
...
@Service
public class MailGateway implements NotificaSolicitanteRelatorioPontoOuputPort {
    ...
    @Override
    public void notificaClienteStatusPedido(RelatorioPontoDTO relatorioPontoDTO) {
        var mail = mailMapper.toMailRelatorioPonto(relatorioPontoDTO, mailFrom, mailFromName);
